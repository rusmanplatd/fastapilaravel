...
# For legacy functions, gradually add typing
# Step 1: Add basic return type annotation
def complex_legacy_function() -> Any:  # Start with Any, refine later
    # Complex legacy logic here
    return some_complex_result

# Step 2: Refine with more specific types as you understand the function
def complex_legacy_function() -> Union[Dict[str, Any], List[Any], None]:
    # Legacy logic with better type hints
    return some_complex_result

# Step 3: Final typed version
def complex_legacy_function() -> Dict[str, Union[str, int, List[str]]]:
    """Process legacy data with full type safety."""
    # Fully typed implementation
    return some_complex_result

# Use the properly typed function
result = complex_legacy_function()  # Now fully typed!
```
