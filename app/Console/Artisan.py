...
class Kernel:
    ...
    def call(self, command: str, parameters: Optional[Dict[str, Any]] = None) -> int:
        ...
        try:
            ...
            exit_code = command_instance.handle()
...
try:
    import app.Console.Commands.MigrationCommands  # This will trigger registration
except ImportError:
    pass  # Migration commands not available

# Import and register factory commands
try:
    import app.Console.Commands.FactoryCommands  # This will trigger registration
except ImportError:
    pass  # Factory commands not available