...
from .BaseModel import BaseModel as EnhancedModel
try:
...
R = TypeVar('R', bound='EnhancedModel')
...
class RelationshipConfig:
    ...
    name: str
    related_model: Type[EnhancedModel]
    relation_type: RelationType
    foreign_key: Optional[str] = None
    local_key: Optional[str] = None
    through_model: Optional[Type[EnhancedModel]] = None
...
class Relation(ABC):
    ...
    def __init__(self, parent: EnhancedModel, related: Type[EnhancedModel], config: RelationshipConfig):
        self.parent = parent
    ...
    @abstractmethod
    def get_results(self) -> Union[EnhancedModel, List[EnhancedModel], None]:
...
class HasOne(Relation):
    ...
    def get_results(self) -> Optional[EnhancedModel]:
...
class HasMany(Relation):
    ...
    def get_results(self) -> List[EnhancedModel]:
...
class BelongsToMany(Relation):
    ...
    def sync(self, ids: List[int], detaching: bool = True) -> None:
        ...
        parent_id = getattr(self.parent, self.parent.get_key_name())  # type: ignore[attr-defined]
...
class RelatedModel(EnhancedModel):
    ...
    @classmethod
    def with_relationships(cls, *relations: str) -> QueryBuilder:
    ...
    @classmethod
    def with_count(cls, *relations: str) -> QueryBuilder:  # type: ignore[override]
...
class RelationshipQueryBuilder(QueryBuilder):
    """Enhanced query builder with relationship support."""
    ...
    def get(self) -> List[RelatedModel]:  # type: ignore[override]
        """Execute query with eager loading."""
        self._apply_eager_loading()
        results: List[RelatedModel] = super().get()
