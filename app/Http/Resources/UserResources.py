...
class UserResource(JsonResource):
    ...
    def _get_full_name(self, user: Any) -> str:
    ...
    def _get_avatar_url(self, user: Any) -> Optional[str]:
    ...
    def _get_security_data(self, user: Any, is_self: bool, is_admin: bool) -> Dict[str, Any]:
    ...
    def _get_mfa_data(self, user: Any) -> Optional[Dict[str, Any]]:
    ...
    def _get_activity_data(self, user: Any) -> Dict[str, Any]:
...
class UserProfileResource(JsonResource):
    """
    ...
    def _get_public_stats(self, user: Any) -> Dict[str, Any]:
...
class UserAdminResource(JsonResource):
    """
...
class UserListResource(JsonResource):
    """
...
class UserSecurityResource(JsonResource):
    """
...
class UserCollection(ResourceCollection):
    ...
    def collect(self, request: Optional[Request] = None) -> Dict[str, Any]:
    ...
    def with_meta(self, meta: Dict[str, Any]) -> 'UserCollection':
...
class RoleResource(JsonResource):
...
class PermissionResource(JsonResource):
...
class OrganizationResource(JsonResource):
