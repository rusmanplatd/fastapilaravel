...
class ActivityLogController:
    ...
    def get_activity_log(
        ...
        return ActivityLogResponse.model_validate(log)  # type: ignore[attr-defined]
    ...
    def create_activity_log(
        ...
        try:
            ...
            return ActivityLogResponse.model_validate(log)  # type: ignore[attr-defined]  # type: ignore[attr-defined]
