...
class PostController(ApiResourceController[Post, PostResource]):
    ...
    async def featured(self, request: Request) -> Dict[str, Any]:
    ...
    async def by_category(self, category: str, request: Request) -> Dict[str, Any]:
        ...
        def category_query(req: Request) -> Any:
    ...
    async def by_tag(self, tag: str, request: Request) -> Dict[str, Any]:
        """Get posts by tag (GET /posts/tag/{tag})."""
        # Temporarily modify query to filter by tag
        original_query_method = self.build_index_query
        
        def tag_query(req: Request) -> Any:
            query = original_query_method(req)
    ...
    async def paginate_query(self, query: Any, offset: int, limit: int) -> List[Post]:
    ...
    def _can_edit_post(self, post: Post, user: Optional[Any]) -> bool:
    ...
    def _can_delete_post(self, post: Post, user: Optional[Any]) -> bool:
