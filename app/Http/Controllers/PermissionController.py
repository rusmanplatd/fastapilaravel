...
class PermissionController(BaseController):
    ...
    def get_user_permissions(
        ...
        return self.success_response(
            data={
                "user_id": user_id,
                "direct_permissions": [PermissionResponse.model_validate(perm) for perm in user_permissions["direct_permissions"]],                "all_permissions": [PermissionResponse.model_validate(perm) for perm in user_permissions["all_permissions"]]            },
