...
class AppServiceProvider(ServiceProvider):
    """
    Laravel-style App Service Provider.
    
    This is the main service provider for the application where you should
    register your application services, similar to Laravel's AppServiceProvider.
    """
    ...
    def register(self) -> None:
        ...
        self.container.singleton("LogManager", lambda c: self._create_log_manager())
    ...
    def _create_log_manager(self) -> Any:
        ...
        config = self.container.make("ConfigRepository")
    ...
    def _register_aliases(self) -> None:
        ...
        self.container.alias("LogManager", "log")
