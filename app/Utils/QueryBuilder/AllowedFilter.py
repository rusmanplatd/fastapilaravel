...
from typing import Any, Optional, Union, List, Callable, Dict, TYPE_CHECKING, cast
...
class AllowedFilter:
    ...
    def _parse_array_values(self, value: Any) -> Any:
...
class OperatorFilter(FilterInterface):
    ...
    def _apply_dynamic_operator(self, query: SQLQuery, column: Column, value: Any) -> SQLQuery:
    ...
    def _parse_operator_string(self, value: str) -> tuple[str, Any]:
    ...
    def _apply_static_operator(self, query: SQLQuery, column: Column, value: Any) -> SQLQuery:
    ...
    def _apply_operator(self, query: SQLQuery, column: Column, operator: str, value: Any) -> SQLQuery:
