...
class HorizonDashboard:
    ...
    def setup_routes(self, app: FastAPI) -> None:
        ...
        app.mount("/horizon/assets", StaticFiles(directory="resources/assets/horizon"), name="horizon-assets")
        ...
        @app.get("/horizon/api/stats")
        async def get_stats():
            """API endpoint for dashboard statistics."""
            return await self.horizon.get_dashboard_stats()
        
        @app.get("/horizon/api/supervisors")
        async def get_supervisors():
            """Get supervisor information."""
            stats = await self.horizon.get_dashboard_stats()
            return stats.get('supervisors', [])
        
        @app.get("/horizon/api/queues")
        async def get_queues():
            """Get queue information."""
            stats = await self.horizon.get_dashboard_stats()
            return stats.get('queues', {})
        
        @app.get("/horizon/api/workers")
        async def get_workers():
            """Get worker information."""
            stats = await self.horizon.get_dashboard_stats()
            return stats.get('workers', [])
        
        @app.get("/horizon/api/jobs")
        async def get_jobs():
            """Get job statistics."""
            stats = await self.horizon.get_dashboard_stats()
            return stats.get('jobs', {})
        
        @app.get("/horizon/api/metrics")
        async def get_metrics():
            """Get system metrics."""
            stats = await self.horizon.get_dashboard_stats()
            return stats.get('metrics', {})
        
        @app.post("/horizon/api/supervisors/{supervisor_name}/pause")
        ...
        @app.post("/horizon/api/supervisors/{supervisor_name}/continue")
