...
class Pipeline:
    ...
    def __init__(self, passable: Any) -> None:
        ...
        self.pipes: List[Union[Callable[..., Any], str, Any]] = []
        self.method = "handle"
    ...
    def through(self, pipes: List[Union[Callable[..., Any], str, Any]]) -> Pipeline:
    ...
    def _carry(self, pipe: Union[Callable[..., Any], str, Any], stack: Callable[[Any], Any]) -> Callable[[Any], Any]:
