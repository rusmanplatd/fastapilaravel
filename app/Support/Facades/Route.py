...
class Route(Facade):
    ...
    def current(cls) -> Optional[Dict[str, Any]]:
        ...
        """
        return cls.get_facade_root().get_current_route()  # type: ignore
    ...
    def has(cls, name: str) -> bool:
        ...
        """
        return cls.get_facade_root().has_route(name)  # type: ignore
    ...
    def url(cls, name: str, parameters: Optional[Dict[str, Any]] = None) -> str:
        ...
        return cls.get_facade_root().generate_url(name, parameters)  # type: ignore
