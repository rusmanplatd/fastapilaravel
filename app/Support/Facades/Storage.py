...
class Storage(Facade):
    ...
    def exists(cls, path: str) -> bool:
        ...
        return cls.get_facade_root().exists(path)  # type: ignore    
    @classmethod
    def missing(cls, path: str) -> bool:
        """Check if file is missing."""
        return cls.get_facade_root().missing(path)  # type: ignore    
    @classmethod
    def get(cls, path: str) -> bytes:
        """Get file contents as bytes."""
        return cls.get_facade_root().get(path)  # type: ignore    
    @classmethod
    def read(cls, path: str) -> str:
        """Read file as string."""
        return cls.get_facade_root().read(path)  # type: ignore    
    @classmethod
    def put(cls, path: str, contents: Union[str, bytes]) -> bool:
        """Store a file."""
        return cls.get_facade_root().put(path, contents)  # type: ignore    
    @classmethod
    def write(cls, path: str, contents: str) -> bool:
        """Write string to file."""
        return cls.get_facade_root().write(path, contents)      # type: ignore
    @classmethod
    def put_file(cls, path: str, file: Union[BinaryIO, TextIO]) -> bool:
        """Store an uploaded file."""
        return cls.get_facade_root().put_file(path, file)      # type: ignore
    @classmethod
    def put_file_as(cls, path: str, file: Union[BinaryIO, TextIO], name: str) -> str:
        """Store file with a specific name."""
        return cls.get_facade_root().put_file_as(path, file, name)      # type: ignore
    @classmethod
    def prepend(cls, path: str, data: str) -> bool:
        """Prepend to a file."""
        return cls.get_facade_root().prepend(path, data)      # type: ignore
    @classmethod
    def append(cls, path: str, data: str) -> bool:
        """Append to a file."""
        return cls.get_facade_root().append(path, data)      # type: ignore
    @classmethod
    def delete(cls, paths: Union[str, List[str]]) -> bool:
        """Delete file(s)."""
        return cls.get_facade_root().delete(paths)      # type: ignore
    @classmethod
    def copy(cls, from_path: str, to_path: str) -> bool:
        """Copy a file."""
        return cls.get_facade_root().copy(from_path, to_path)      # type: ignore
    @classmethod
    def move(cls, from_path: str, to_path: str) -> bool:
        """Move a file."""
        return cls.get_facade_root().move(from_path, to_path)      # type: ignore
    # File metadata
    @classmethod
    def size(cls, path: str) -> int:
        """Get file size."""
        return cls.get_facade_root().size(path)      # type: ignore
    @classmethod
    def last_modified(cls, path: str) -> int:
        """Get last modified timestamp."""
        return cls.get_facade_root().last_modified(path)      # type: ignore
    @classmethod
    def mime_type(cls, path: str) -> Optional[str]:
        """Get file MIME type."""
        return cls.get_facade_root().mime_type(path)      # type: ignore
    # Directory operations
    @classmethod
    def files(cls, directory: Optional[str] = None, recursive: bool = False) -> List[str]:
        """Get list of files."""
        return cls.get_facade_root().files(directory, recursive)      # type: ignore
    @classmethod
    def all_files(cls, directory: Optional[str] = None) -> List[str]:
        """Get all files recursively."""
        return cls.get_facade_root().all_files(directory)      # type: ignore
    @classmethod
    def directories(cls, directory: Optional[str] = None, recursive: bool = False) -> List[str]:
        """Get list of directories."""
        return cls.get_facade_root().directories(directory, recursive)      # type: ignore
    @classmethod
    def all_directories(cls, directory: Optional[str] = None) -> List[str]:
        """Get all directories recursively."""
        return cls.get_facade_root().all_directories(directory)      # type: ignore
    @classmethod
    def make_directory(cls, path: str) -> bool:
        """Create directory."""
        return cls.get_facade_root().make_directory(path)      # type: ignore
    @classmethod
    def delete_directory(cls, directory: str) -> bool:
        """Delete directory."""
        return cls.get_facade_root().delete_directory(directory)      # type: ignore
    # URLs and downloads
    @classmethod
    def url(cls, path: str) -> str:
        """Get public URL for file."""
        return cls.get_facade_root().url(path)      # type: ignore
    @classmethod
    def temporary_url(cls, path: str, expiration: datetime) -> str:
        """Get temporary URL for file."""
        return cls.get_facade_root().temporary_url(path, expiration)      # type: ignore
    @classmethod
    def download(cls, path: str, name: Optional[str] = None) -> bytes:
        """Download a file."""
        return cls.get_facade_root().download(path, name)      # type: ignore
    @classmethod
    ...
    def put_json(cls, path: str, data: Any) -> bool:
        ...
        return cls.get_facade_root().put_json(path, data)      # type: ignore
    # Utility methods
    @classmethod
    def checksum(cls, path: str) -> str:
        """Get file checksum."""
        return cls.get_facade_root().checksum(path)      # type: ignore
    @classmethod
    def file_hash(cls, path: str, algorithm: str = 'md5') -> str:
        """Get file hash using specified algorithm."""
        return cls.get_facade_root().file_hash(path, algorithm)      # type: ignore
    @classmethod
    def path(cls, path: str) -> str:
        """Get absolute path to file."""
        return cls.get_facade_root().path(path)      # type: ignore
    @classmethod
    def read_stream(cls, path: str) -> BinaryIO:
        """Get file as stream."""
        return cls.get_facade_root().read_stream(path)      # type: ignore
    @classmethod
    def write_stream(cls, path: str, resource: BinaryIO) -> bool:
        """Write stream to file."""
        return cls.get_facade_root().write_stream(path, resource)      # type: ignore
    # Cloud sync operations
    @classmethod
    def sync_to_cloud(cls, local_path: str, cloud_path: Optional[str] = None) -> bool:
        """Sync local file to cloud storage."""
        return cls.get_facade_root().sync_to_cloud(local_path, cloud_path)      # type: ignore
    @classmethod
    def sync_from_cloud(cls, cloud_path: str, local_path: Optional[str] = None) -> bool:
        """Sync cloud file to local storage."""
        return cls.get_facade_root().sync_from_cloud(cloud_path, local_path)      # type: ignore
    # Configuration
    @classmethod
