...
from app.Models.MFACode import MFACodeType, MFACode as MFACodeModel
...
try:
    ...
    # Type-safe fallbacks for when Twilio is not available
    TwilioClient = type(None)  # type: ignore[assignment,misc]
...
class SMSService(BaseService):
    ...
    def _verify_sms_code(  # type: ignore[no-any-unimported]
        self,
        user: User,
        code: str,
