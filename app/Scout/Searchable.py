...
class SearchableConfig:
    ...
    searchable_data: Optional[Callable] = None  # Custom data transformation
    scout_key: Optional[str] = None  # Custom primary key field
    
    # Indexing configuration
    should_be_searchable: Optional[Callable] = None  # Conditional indexing
...
class Searchable:
    ...
    def get_scout_key(self) -> Union[str, int]:
        ...
        return getattr(self, scout_key_field)
