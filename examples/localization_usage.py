"""
Example usage of Laravel-style Localization system
"""
from fastapi import FastAPI, Request, HTTPException, status
from fastapi.responses import JSONResponse

from app.Localization import translator, __, trans, trans_choice, set_app_locale
from app.Http.Middleware.LocaleMiddleware import LocaleMiddleware, LocaleHelper

# Initialize FastAPI app
app = FastAPI(title="Localization Example")
