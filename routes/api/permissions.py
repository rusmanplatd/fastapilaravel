...
from app.Http.Controllers.Api.PermissionController import PermissionController
...
@permissions_router.post("/", response_model=Dict[str, Any])
...
@permissions_router.get("/", response_model=Dict[str, Any])
async def get_permissions(
    ...
    return permission_controller.get_permissions(current_user, db, skip, limit, active_only, search)


@permissions_router.get("/{permission_id}", response_model=Dict[str, Any])
...
@permissions_router.put("/{permission_id}", response_model=Dict[str, Any])
...
@permissions_router.delete("/{permission_id}", response_model=Dict[str, Any])
...
@permissions_router.post("/{permission_id}/deactivate", response_model=Dict[str, Any])
...
@permissions_router.post("/{permission_id}/activate", response_model=Dict[str, Any])
...
@permissions_router.post("/assign-to-user", response_model=Dict[str, Any])
...
@permissions_router.post("/users/{user_id}/check", response_model=Dict[str, Any])
...
@permissions_router.post("/users/{user_id}/check-multiple", response_model=Dict[str, Any])
...
@permissions_router.get("/users/{user_id}", response_model=Dict[str, Any])
...
@permissions_router.post("/bulk-create", response_model=Dict[str, Any])
