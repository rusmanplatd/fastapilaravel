...
async def get_supervisor_details(supervisor_name: str) -> Dict[str, Any]:
    ...
    if not supervisor:
        raise HTTPException(
            status_code=404,
            detail=f"Supervisor {supervisor_name} not found"
        )
...
async def get_queue_details(queue_name: str) -> Dict[str, Any]:
